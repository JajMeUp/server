...
public class AlarmController {
    ...
    @RequestMapping(value = "/lastalarm", method = RequestMethod.GET)
    public ResponseEntity lastAlarm() {
        return ResponseEntity.status(HttpStatus.OK).body(service.getLastAlarm());
    }
}
